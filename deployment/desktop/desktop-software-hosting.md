...
# How to Host Desktop Software

This section explains how to set up a Yum repository for RPM packages that provides the needed metadata. If you are making a Flatpak we recommend skipping ahead to the [Flatpak section](how-to-setup-and-host-flatpaks.html).
...
```
$ sudo dnf install libappstream-glib-builder
```
